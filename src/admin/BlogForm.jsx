            ...
            <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-sm p-5 space-y-4">
              ...
              <Field label="Slug" hint="Auto-generated from title. Lowercase, hyphens only.">
                <div className="flex items-center">
                  <span className="px-3 py-2.5 bg-[#f8fafc] border border-r-0 border-[#e2e8f0] rounded-l-lg text-xs text-[#94a3b8]">/blogs/</span>
                  <Input
                    value={form.slug}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#f8fafc] rounded-xl border border-[#e2e8f0] p-4">
                      ...
                      <p className="text-green-700 text-xs mt-0.5">
                        amatir.in/blogs/{form.slug || 'your-post-slug'}
                      </p>
            ...
            <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-sm p-5 space-y-4">
              ...
              <label className="flex items-center gap-2.5 cursor-pointer">
                <div className="relative">
                  ...
                  />
                  <div className={`w-10 h-5 rounded-full transition-colors ${form.featured ? 'bg-[#ED6D23]' : 'bg-[#e2e8f0]'}`} />
            ...
            <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-sm p-5 space-y-4">
              ...
              <Field label="Category">
                ...
                <datalist id="category-suggestions">
                  {['Education', 'Academics', 'Boarding', 'Life at Amatir', 'Admissions', 'Events', 'News', 'General'].map((c) => (
