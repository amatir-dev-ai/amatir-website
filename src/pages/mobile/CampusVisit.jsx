...
export default function CampusVisit() {
  ...
  return (
    <div className="min-h-screen w-full bg-white text-slate-800 overflow-x-hidden">
      ...
      <section className="relative" style={{ height: '100vh', marginTop: '60px' }}>
        ...
        <div className="absolute inset-x-0 bottom-[12%] flex flex-col items-center justify-end px-4">
          <img
            ...
            className={`mb-4 opacity-95 ${
              isSmallMobile ? 'h-6 w-6' : isMobile ? 'h-8 w-8' : isLandscapeTablet ? 'h-9 w-9' : 'h-10 w-10'
            }`}
          />
          <h1
            className={`px-4 text-center font-serif leading-none text-white ${
              isSmallMobile
                ? 'text-[28px]'
                : isMobile
                  ? 'text-[32px]'
