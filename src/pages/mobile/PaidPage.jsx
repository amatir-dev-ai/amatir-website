    ...
    <>
      ...
      <Container>
        <h2
          ...
          style={{ color: "#1C3664", fontFamily: '"CentSchbkCyrill BT", serif' }}
        >
          In Their Own
          <br />
          Words
...
function WhyTrust({ touchRef }) {
  ...
  return (
    ...
    >
      ...
      {/* <div className="rounded overflow-hidden" ref={touchRef}>
        <h3
          className="cent-schbk-cyrill text-center font-semibold"
          style={{
            color: BRAND.navy,
        ...
        >
          ...
          <iframe
            ...
            style={{
              width: "100%",
              height: "850px", // fixed to show full form
              border: "none",
              borderRadius: "12px",
              overflow: "hidden", // 🔥 hide Zoho’s own scrollbar
            }}
            scrolling="no" // 🔥 disable Zoho iframe scrollbar
            allowFullScreen
            loading="lazy"
          ></iframe>
        </div>
