  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        {blog.excerpt && (
          <p className="text-[#64748b] text-sm leading-relaxed line-clamp-3 mb-4 flex-1">{blog.excerpt}</p>
        )}
...
function FeaturedCard({ blog }) {
  ...
  return (
    ...
    >
      ...
      <div className="md:w-1/2 flex flex-col justify-center p-6 md:p-10 bg-white">
        <h2
        ...
        {blog.excerpt && <p className="text-[#64748b] text-sm leading-relaxed mb-5 line-clamp-3">{blog.excerpt}</p>}
...
export default function Blogs() {
  useSEO({
    ...
    description:
      'Insights, updates, and stories from Amatir Kanya Gurukul. Explore our latest articles on education, boarding life, academics, and more.',
  ...
  return (
    <>
      {/* Hero */}
      <section className="pt-28 pb-16 px-4" style={{ background: `linear-gradient(135deg, ${NAVY} 0%, #2a4a84 100%)` }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-xl mx-auto mb-8">
            Explore articles on education, boarding life, academics, and the journey of nurturing excellence at Amatir
            Kanya Gurukul.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Featured post (only on first page, no search) */}
        ...
        {!loading && !error && blogs.length === 0 && (
          <div className="text-center py-20">
            ...
            <h3
              className="text-[#1C3664] text-xl font-semibold mb-2"
              style={{ fontFamily: 'CentSchbkCyrill BT, serif' }}
            >
              No articles yet
            </h3>
        ...
        {!loading && pagination.pages > 1 && (
          <div className="mt-12 flex items-center justify-center gap-2 flex-wrap">
            ...
            {Array.from({ length: pagination.pages }, (_, i) => i + 1)
              ...
              .map((item, idx) =>
                item === '…' ? (
                  <span key={`ellipsis-${idx}`} className="px-2 text-[#94a3b8] text-sm">
                    …
                  </span>
                ) : (
                  <button
