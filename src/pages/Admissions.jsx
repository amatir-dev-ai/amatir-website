...
const ASSETS = {
  ...
  r100: "/images/visitcampus01_km6bdu.jpg",
  r101: "/images/visitcampus02_yuqzej.jpg",
...
export default function Admissions() {
  ...
  return (
    <main className="w-full overflow-x-hidden bg-white text-[#1C3664]">
      ...
      <section className="relative w-full">
        <div className="relative mx-auto h-[15.75rem] w-full  overflow-hidden">
          ...
          <div className="relative z-[1] mx-auto flex h-full w-full flex-col items-center justify-center text-center text-white">
            <h3 className="font-serif font-normal text-[32px] leading-[120%] text-center">
              Fee Structure
            </h3>
            <p
      ...
      {/* Mobile/tablet version of Visit Campus */}
      <section className="px-5 lg:hidden">
        <h3 className="text-center font-serif text-[2.125rem] leading-tight">
          Visit Campus
        </h3>
        ...
        <div className="mx-auto mt-7 grid max-w-[47.5rem] grid-cols-2 gap-4">
          {[
            ...
            <img
              ...
              src={src}
              alt=""
              className="aspect-[186/228] w-full rounded-[0.625rem] object-cover shadow-[0_0.875rem_1.875rem_rgba(0,20,60,0.12)]"
            />
          ))}
        </div>
        <div className="my-8 flex justify-center">
          <a
            href="/campus-visit"
            className="inline-flex h-[3rem] items-center rounded-full bg-[#ED6D23] px-6 text-[0.938rem] text-white shadow-[0_0.625rem_1.25rem_rgba(237,109,35,0.35)] hover:brightness-105 cursor-pointer"
          >
            Schedule a visit
          </a>
        </div>
      ...
      <section className="relative mx-auto mt-8 w-full   overflow-hidden">
        <div className="relative h-[15.25rem] w-full">
          ...
          <div className="relative z-[1] flex h-full flex-col items-center justify-center text-center text-white">
            ...
            <p className="mt-2 text-center univers-regular opacity-95">
              Guided by Dharma, Prepared for the World.
            </p>
            <Link
              to="/Contact"
              className="mt-4 inline-flex h-[2.375rem] items-center cursor-pointer rounded-full bg-[#1C3664] px-5 text-[0.875rem] font-medium text-white ring-1 ring-white/40 backdrop-blur hover:bg-[#1C3664]/20"
            >
              Get In Touch
            </Link>
          </div>
