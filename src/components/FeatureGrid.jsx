...
const pairs = [
  { image: IMAGES.FeatureGridImages[0], theme: "peach", kicker: "Yoga and Sports", title: "I Begin My Day With Calm, Clarity and Strength", body: "Our mornings begin with a choice of three essentials: energizing sports to awaken the body, yoga to calm the mind, and mindful practices to build focus and inner strength." },
  { image: IMAGES.FeatureGridImages[1], theme: "blue",  kicker: "Vedic Living and Education", title: "Tradition Isn't Just What I Know; It's How I Live", body: "Chanting, Meditation, and Hawans are part of our daily routine. We don't just learn about tradition—we practice it, live it, and carry it forward with meaning and pride." },
  { image: IMAGES.FeatureGridImages[2], theme: "peach", kicker: "Academic Learning and NEET/JEE Coaching", title: "I Study Not Just to Know, but to Grow", body: "Our CBSE curriculum goes beyond textbooks. With hands-on learning, real-world skills, and values woven in, we grow into curious thinkers, confident doers, and grounded individuals." },
